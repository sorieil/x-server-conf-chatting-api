...
const MongoSessions_1 = require("./../../entity/mongodb/main/MongoSessions");
const MongoSchedule_1 = require("../../entity/mongodb/main/MongoSchedule");
const moment_timezone_1 = __importDefault(require("moment-timezone"));
class ServiceSchedule {
    constructor() { }
    getScheduleByEventId(event, date, timezone) {
        return __awaiter(this, void 0, void 0, function* () {
            const sessionsQuery = yield MongoSessions_1.Sessions.findOne({
                eventId: event._id,
            ...
            if (sessionsQuery) {
                ...
                if (scheduleQuery.length > 0) {
                    return new Promise(resolve => {
                        ...
                        const result = scheduleQuery.map((v) => {
                            // comment가 존재한다면, 임시 프로필 추가
                            if (typeof v.comment !== 'undefined') {
                                v.comment.map((c) => Object.assign(c, {
                                    name: '홍길동',
